...
class Command(BaseCommand):
    ...
    def new_edge(self,edge_source,edge_destination):
        e = Edge()
        e.source = Node.objects.get(name=edge_source)
        e.destination = Node.objects.get(name=edge_destination)
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            print("404 Not Found.")
            return None
        if origin is "+":       # when the word dont have a origin.
            print("Skipped")
            return None
